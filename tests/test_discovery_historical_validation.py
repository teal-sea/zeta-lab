...
from ontology import historical_cases as HC
from ontology.domains import zeta_domain as Z
from ontology.domains import zeta_history as ZH
from ontology.funnel import DISPOSITIONS, run_funnel
from ontology.knownness import FACT_STATUSES, FORBIDDEN_LABEL_WORDS
from ontology.ledger import Ledger
from ontology.registry import Domain, validate_domain
...
def test_importing_the_harness_pulls_in_no_laboratory_module() -> None:
    ...
    code = (
        ...
        "import ontology.historical_cases;"
...
def test_the_mertens_case_would_actually_fail_if_the_funnel_endorsed_it(tmp_path) -> None:
    ...
    from ontology.registry import BaseKnownnessDetector, BaseScreen, ScreenResult
    from ontology.schema import Precision
