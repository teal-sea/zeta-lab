...
**⚠ THE METADATA PATH MUST BE SELECTED EXPLICITLY IN THE SUBMISSION FORM. THE DEFAULT
RESOLVES TO V1 AND THE REVIEW WILL REFUSE.** Learned on 2026-08-25, from a refusal.
...
- A refusal is **private**. Nothing about it becomes public, and it is not a mark against the
  entry. But it does consume a submission cycle, which is the cost worth avoiding.
