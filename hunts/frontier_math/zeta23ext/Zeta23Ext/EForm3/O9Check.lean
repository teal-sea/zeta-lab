...
theorem o9_chunk8 : o9Walk (o9cells.drop 320 |>.take 40) = true := by
  decide +kernel
theorem o9_chunk9 : o9Walk (o9cells.drop 360 |>.take 40) = true := by
  decide +kernel
theorem o9_chunk10 : o9Walk (o9cells.drop 400 |>.take 40) = true := by
  decide +kernel
theorem o9_chunk11 : o9Walk (o9cells.drop 440 |>.take 40) = true := by
  decide +kernel
