...
| `harden.py zeta 64`, `zeta 128` | build at 1600 bits + LDL, ~1-3 s per cell | 98 cells | ~3 min | |
| `precision_check.py` | 3 recomputations per cell at up to 2x precision, zeta N=128 HF at 3200 bits dominates | 4 cells | ~3 min | |
