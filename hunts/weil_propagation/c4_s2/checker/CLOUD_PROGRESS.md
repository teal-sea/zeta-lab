...
2026-09-24T14:25:39Z review fixes: ratios quoted 2.5 / 4.5 / 8.6 (was '2.5 to 8.5'); s7.7 table pinned cell by cell; stale 'CI proposal' text removed from run_checker_ts.py and the band_rule in checker_ts_cells.json (re-analysed, 015895f); s7.3a points to s7.7. two_adic/ tests: 86 passed after the prolate re-run. Checker suite 170 passed, 11 skipped, 3 xfailed; make_context --check clean. DONE.
