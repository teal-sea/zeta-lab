...
lemma ch_33 (x y z : ℝ) (hx1 : (131/128:ℝ) ≤ x) (hx2 : x ≤ (529/512:ℝ))
...
set_option maxHeartbeats 20000000 in
lemma ch_51 (x y z : ℝ) (hx1 : (1073/1024:ℝ) ≤ x) (hx2 : x ≤ (2151/2048:ℝ))
...
set_option maxHeartbeats 20000000 in
lemma ch_74 (x y z : ℝ) (hx1 : (2151/2048:ℝ) ≤ x) (hx2 : x ≤ (539/512:ℝ))
...
set_option maxHeartbeats 20000000 in
lemma ch_84 (x y z : ℝ) (hx1 : (4277/4096:ℝ) ≤ x) (hx2 : x ≤ (2141/2048:ℝ))
...
set_option maxHeartbeats 20000000 in
lemma ch_92 (x y z : ℝ) (hx1 : (2141/2048:ℝ) ≤ x) (hx2 : x ≤ (4287/4096:ℝ))
...
set_option maxHeartbeats 20000000 in
lemma ch_120 (x y z : ℝ) (hx1 : (267/256:ℝ) ≤ x) (hx2 : x ≤ (4277/4096:ℝ))
...
set_option maxHeartbeats 20000000 in
lemma ch_125 (x y z : ℝ) (hx1 : (267/256:ℝ) ≤ x) (hx2 : x ≤ (2141/2048:ℝ))
...
set_option maxHeartbeats 20000000 in
lemma ch_167 (x y z : ℝ) (hx1 : (267/256:ℝ) ≤ x) (hx2 : x ≤ (1073/1024:ℝ))
...
set_option maxHeartbeats 20000000 in
lemma ch_168 (x y z : ℝ) (hx1 : (267/256:ℝ) ≤ x) (hx2 : x ≤ (1073/1024:ℝ))
...
set_option maxHeartbeats 20000000 in
lemma ch_174 (x y z : ℝ) (hx1 : (267/256:ℝ) ≤ x) (hx2 : x ≤ (1073/1024:ℝ))
    (hy1 : (509/256:ℝ) ≤ y) (hy2 : y ≤ (2041/1024:ℝ))
...
set_option maxHeartbeats 20000000 in
lemma ch_178 (x y z : ℝ) (hx1 : (267/256:ℝ) ≤ x) (hx2 : x ≤ (539/512:ℝ))
    ...
    · rcases le_total y (2051/1024:ℝ) with hc | hc
      ...
      · rcases le_total z (1073/1024:ℝ) with hc | hc
        ...
        · have hw0 : (160574441/10000000000000:ℝ) ≤ wfun x := wc_72 x (by linarith) (by linarith)
          ...
          have hw3 : (694482783/10000000000000:ℝ) ≤ wfun (x + y) := wc_570 (x + y) (by linarith) (by linarith)
          have hw4 : (694482783/10000000000000:ℝ) ≤ wfun (y + z) := wc_570 (y + z) (by linarith) (by linarith)
          have hw5 : (1386999573/5000000000000:ℝ) ≤ wfun (x + y + z) := wc_1189 (x + y + z) (by linarith) (by linarith)
          linarith
  · rcases le_total x (1073/1024:ℝ) with hc | hc
    · have hw0 : (349265369/5000000000000:ℝ) ≤ wfun x := wc_40 x (by linarith) (by linarith)
      have hw1 : (179073511/2000000000000:ℝ) ≤ wfun y := by
...
set_option maxHeartbeats 20000000 in
lemma ch_182 (x y z : ℝ) (hx1 : (17/16:ℝ) ≤ x) (hx2 : x ≤ (73/64:ℝ))
              ...
              · rcases le_total z (267/256:ℝ) with hc | hc
                · rcases le_total x (549/512:ℝ) with hc | hc
                  ...
                  · have hw0 : (1609622259/10000000000000:ℝ) ≤ wfun x := wc_106 x (by linarith) (by linarith)
                    ...
                    have hw2 : (1626727581/10000000000000:ℝ) ≤ wfun z := wc_13 z (by linarith) (by linarith)
                    have hw3 : (285997/2500000000000:ℝ) ≤ wfun (x + y) := wc_366 (x + y) (by linarith) (by linarith)
                    have hw4 : (28217469/5000000000000:ℝ) ≤ wfun (y + z) := by
                      rcases le_total (y + z) (3:ℝ) with hq40 | hq40
                      · exact le_trans (by norm_num) (wc_312 (y + z) (by linarith) (by linarith))
                      exact le_trans (by norm_num) (wc_327 (y + z) (by linarith) (by linarith))
                    ...
                    · rcases le_total z (539/512:ℝ) with hc | hc
                      · rcases le_total x (1093/1024:ℝ) with hc | hc
                        · rcases le_total y (2011/1024:ℝ) with hc | hc
                          · have hw0 : (40709377/2000000000000:ℝ) ≤ wfun x := wc_100 x (by linarith) (by linarith)
                          ...
                          · have hw0 : (40709377/2000000000000:ℝ) ≤ wfun x := wc_100 x (by linarith) (by linarith)
                            ...
                            linarith
                        · have hw0 : (753911279/10000000000000:ℝ) ≤ wfun x := wc_105 x (by linarith) (by linarith)
                          have hw1 : (694601603/1000000000000:ℝ) ≤ wfun y := wc_125 y (by linarith) (by linarith)
                          have hw2 : (160574441/10000000000000:ℝ) ≤ wfun z := wc_41 z (by linarith) (by linarith)
                    ...
                    · rcases le_total z (529/512:ℝ) with hc | hc
                      ...
                      · rcases le_total x (1093/1024:ℝ) with hc | hc
                        ...
                        · have hw0 : (753911279/10000000000000:ℝ) ≤ wfun x := wc_105 x (by linarith) (by linarith)
                          ...
                          have hw2 : (1626727581/10000000000000:ℝ) ≤ wfun z := wc_19 z (by linarith) (by linarith)
                          have hw3 : (489049523/10000000000000:ℝ) ≤ wfun (x + y) := wc_565 (x + y) (by linarith) (by linarith)
                          have hw5 : (1642534177/10000000000000:ℝ) ≤ wfun (x + y + z) := wc_1110 (x + y + z) (by linarith) (by linarith)
                          linarith
                  · rcases le_total y (1013/512:ℝ) with hc | hc
                    · have hw0 : (1609622259/10000000000000:ℝ) ≤ wfun x := wc_106 x (by linarith) (by linarith)
                      have hw1 : (4884069333/10000000000000:ℝ) ≤ wfun y := wc_132 y (by linarith) (by linarith)
            ...
            · rcases le_total y (519/256:ℝ) with hc | hc
              · rcases le_total z (267/256:ℝ) with hc | hc
                ...
                · have hw0 : (38452957/2000000000000:ℝ) ≤ wfun x := wc_102 x (by linarith) (by linarith)
                  ...
                  have hw5 : (1808088631/5000000000000:ℝ) ≤ wfun (x + y + z) := wc_1196 (x + y + z) (by linarith) (by linarith)
                  linarith
              · have hw0 : (38452957/2000000000000:ℝ) ≤ wfun x := wc_102 x (by linarith) (by linarith)
                ...
                have hw5 : (709810229/2000000000000:ℝ) ≤ wfun (x + y + z) := wc_1197 (x + y + z) (by linarith) (by linarith)
                linarith
            · have hw0 : (4137262453/10000000000000:ℝ) ≤ wfun x := wc_107 x (by linarith) (by linarith)
...
set_option maxHeartbeats 20000000 in
lemma ch_211 (x y z : ℝ) (hx1 : (121/64:ℝ) ≤ x) (hx2 : x ≤ (63/32:ℝ))
...
set_option maxHeartbeats 20000000 in
lemma ch_219 (x y z : ℝ) (hx1 : (121/64:ℝ) ≤ x) (hx2 : x ≤ (141/64:ℝ))
