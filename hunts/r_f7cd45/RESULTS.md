...
Cost, measured: 22.8 s, 23.7 s, 5.9 s, 0.0 s, 0.0 s. Total stage 1 runtime is ~52 s.
Property 3 uses `LINE_WINDOW = (10, 16)` where every rival has zeros on the
critical line, confirming the vacuous verdict in seconds.
...
(`MISSION.md`, committed before any winding number was computed), σ ∈ [0.6, 0.9]:
