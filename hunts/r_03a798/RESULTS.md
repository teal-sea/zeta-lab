...
| `test_guard_ledger.py` | specific paths cited by ledger | **no** |
...
above is the hand-checked reading of the test files.)*
...
perfectly proper. Do not read "58 uses" as "58 violations": I did not
...
- **How many of the `use`-class hits are genuine overclaims.** Requires
  reading each in context and a judgment about the claim behind it.
